...
exception to this. To see if these appeal-based design decisions truly have
...
\begin{equation}
Y_i = \beta_0 + \beta_1 X_i + \beta_2 X_i (\#eq:linm)
\end{equation}
...
The null hypothesis of this model therefore seeks to explore whether there 
...
$Y_i$, the dependent variable, is a player's total spending in pearl shop,
$\beta_0$ is the intercept, $\beta_1$ is the covariate of total playtime,
$\beta_2$ is the covariate of number of female characters the player has.

Since the dependent variable is continuous, a linear model is considered instead
of a logistic model. For the analysis in the rest of this section, the dataset
...
TODO; Concrete findings accompanied by graphs
