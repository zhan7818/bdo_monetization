...
In contrast, microtransactions in BDO accounts for roughly 95% of the total
revenue, as show in table \@ref(tab:table4), a staggeringly high difference.
...
that publishers are already catching on to these whales and the best strategy
